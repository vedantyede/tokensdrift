...
export interface ReportMeta {
  ...
  reportId?: string;
  /**
   * "Published by TokensDrift" editorial teardown mode — distinct banner
...
<title>${meta.teardownTitle ? escapeHtml(meta.teardownTitle) : `TokensDrift Report — Score ${score}/100`}</title>
<style>
...
<div class="wrap">
  ...
  <div class="card teardown-banner">
    <div class="teardown-eyebrow">📰 Published by TokensDrift — editorial teardown</div>
  ...
  <div class="card hero">
    ...
    <div>
      ...
      <div class="muted">Generated ${escapeHtml(meta.generatedAt)} · TokensDrift ${escapeHtml(meta.toolVersion)} · scoreVersion ${aggregate.driftScore.scoreVersion}</div>
  ...
  <footer class="muted">Generated by <strong>tokensdrift</strong> — <a href="https://tokensdrift.com" style="color:inherit">tokensdrift.com</a></footer>
</div>
</body>
</html>
`;
